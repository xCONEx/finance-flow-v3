...
-- CORREÇÃO DAS FUNÇÕES DE AGÊNCIA COM ERROS
-- Corrigir get_user_agencies e criar get_all_companies_for_admin

-- 1. VERIFICAR E ADICIONAR COLUNA DESCRIPTION NA TABELA AGENCIES SE NÃO EXISTIR
DO $$
BEGIN
...
-- 4. RECRIAR OUTRAS FUNÇÕES ADMIN DE EMPRESA
...
DO $$
BEGIN
    RAISE NOTICE '✅ FUNÇÕES DE AGÊNCIA CORRIGIDAS COM SUCESSO!';
    RAISE NOTICE '🔧 Função get_user_agencies corrigida';
    RAISE NOTICE '🏢 Função get_all_companies_for_admin criada';
    RAISE NOTICE '➕ Função admin_create_company recriada';
    RAISE NOTICE '✏️ Função admin_update_company recriada';
    RAISE NOTICE '🗑️ Função admin_delete_company recriada';
    RAISE NOTICE '🔒 Permissões concedidas para authenticated users';
    RAISE NOTICE '✨ Erros de agência corrigidos!';
END $$;
